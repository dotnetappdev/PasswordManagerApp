...
/// </summary>
public class EdgeImportPlugin : IPasswordImportPlugin
{
    ...
    public EdgeImportPlugin()
    {
        Metadata = new PluginMetadata
        {
            ...
            Tags = new List<string> { "edge", "microsoft", "browser", "csv" }
        };
    }
    ...
    public async Task<ImportResult> ImportFromFileAsync(Stream stream, string fileName)
    {
        try
        {
            ...
            var engine = new FileHelperEngine<EdgeCsvRecord>();
            ...
            {
                Success = true,
                ErrorMessage = $"Successfully imported {passwordItems.Count} items from Edge",
                ...
                RequiredCollections = new List<Collection>
                {
                    ...
                    {
                        Name = "Edge Import",
                        Description = "Passwords imported from Microsoft Edge",
                        Color = "#0078D4" // Edge blue color
                    }
                },
    ...
    public async Task<bool> CanProcessFileAsync(Stream stream, string fileName)
    {
        ...
        try
        {
            ...
            // Edge CSV header (same as Chrome): name,url,username,password
...
/// <summary>
/// Edge CSV record structure (same as Chrome)
/// </summary>
[DelimitedRecord(",")]
