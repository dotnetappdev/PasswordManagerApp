...
| **React Native Mobile App** | iOS and Android mobile app with SQLite and API sync | [REACT_NATIVE_MOBILE_APP.md](REACT_NATIVE_MOBILE_APP.md) · [Setup Guide](react/SETUP.md) |
