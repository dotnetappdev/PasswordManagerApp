...
public class SupabaseDbContext : IdentityDbContext<ApplicationUser>, ISupabaseDbContext, IDisposable
{
    ...
    private void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Collection>().HasData(
            new Collection { Id = 1, Name = "Personal", Icon = "👤", Color = "#3B82F6", CreatedAt = staticDate, IsDefault = true },
            new Collection { Id = 2, Name = "Work", Icon = "💼", Color = "#10B981", CreatedAt = staticDate, IsDefault = false },
            new Collection { Id = 3, Name = "Family", Icon = "👪", Color = "#8B5CF6", CreatedAt = staticDate, IsDefault = false }
        );
