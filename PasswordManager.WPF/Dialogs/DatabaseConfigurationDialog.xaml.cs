...
public sealed partial class DatabaseConfigurationDialog : ModernWpf.Controls.ContentDialog
{
    ...
    private async void OnPrimaryButtonClick(ModernWpf.Controls.ContentDialog sender, ModernWpf.Controls.ContentDialogButtonClickEventArgs args)
    {
        // Validate the path
    ...
    private async void OnCloseButtonClick(ModernWpf.Controls.ContentDialog sender, ModernWpf.Controls.ContentDialogButtonClickEventArgs args)
    {
        // Use default path
        try
        {
