...
### OpenAPI/Scalar
- **API Documentation**: OpenAPI 3.0 document generated by Swashbuckle, rendered as an interactive
  dashboard-style reference by [Scalar](https://scalar.com) at `/scalar`
- **Code Generation**: Client SDK generation from the OpenAPI document
- **Testing**: Built-in try-it-out request/response panel
