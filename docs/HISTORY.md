...
`SETUP.md`, `CONFIGURATION_GUIDE.md`, `DEVELOPMENT.md`, `USER_GUIDE.md`, `SECURITY_SUMMARY.md`,
...
> Current, maintained database/migration docs: `MIGRATION_GUIDE.md`, `EF_IDENTITY_SETUP_GUIDE.md`,
> `ReadMe.DatabaseProviders.md`, `MYSQL_SETUP_GUIDE.md`.
...
- **PBKDF2 upgrade** `[OWASP_PBKDF2_UPGRADE_SUMMARY.md]` — raised PBKDF2 iterations from 100,000 to 600,000
  per OWASP 2024 guidance. (See also `MASTER_PASSWORD_SECURITY.md`, `ENCRYPTION_IMPLEMENTATION.md`.)
...
- **QR sign-in / device management / sync** `[FEATURE_SUMMARY.md]` — QR-code sign-in, device management and
  enhanced sync. (Current: `QR_LOGIN_GUIDE.md`, `DEVICE_MANAGEMENT_IMPLEMENTATION.md`,
