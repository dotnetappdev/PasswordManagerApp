...
## Contents
- [Single Sign-On](SSO.md) - pluggable, config-driven "Continue with &lt;provider&gt;" (Google, Azure AD, Keycloak, ADFS, any OIDC IdP) for Blazor and WPF, identity verification only; see the standalone doc for setup
